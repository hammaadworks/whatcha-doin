...
const ActionsSection: React.FC<ActionsSectionProps> = ({
    ...
    }, [isOwner, isReadOnly, itemsToRender]); // Add isReadOnly to dependency array
    ...
    if (loading && isOwner && !isReadOnly) { // Add isReadOnly check
    ...
    return (<div className="section mb-10">
            ...
            <ActionsList
                ...
                onActionToggled={isOwner && !isReadOnly ? onActionToggled : undefined} // Conditional handler
                onActionAdded={isOwner && !isReadOnly ? onActionAdded : undefined} // Conditional handler
                onActionUpdated={isOwner && !isReadOnly ? onActionUpdated : undefined} // Conditional handler
                onActionDeleted={isOwner && !isReadOnly ? onActionDeleted : undefined} // Conditional handler
                onActionIndented={isOwner && !isReadOnly ? onActionIndented : undefined} // Conditional handler
                onActionOutdented={isOwner && !isReadOnly ? onActionOutdented : undefined} // Conditional handler
                onActionMovedUp={isOwner && !isReadOnly ? onActionMovedUp : undefined} // Conditional handler
                onActionMovedDown={isOwner && !isReadOnly ? onActionMovedDown : undefined} // Conditional handler
                onActionPrivacyToggled={isOwner && !isReadOnly ? onActionPrivacyToggled : undefined} // Conditional handler
